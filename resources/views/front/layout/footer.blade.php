        ...
        <div class="footerDown">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p> {{ $general->footer_bar ? $general->footer_bar : 'GAMEDAY PICKS, LLC © 2023. All Rights Reserved' }}
                    </p>
                    ...
                    <div class="footerIcon">
                        @if (!empty($social_links))
                            ...
                            @if ($social_links['Facebook'] != '')
                                <a href="{{ $social_links['Facebook'] }}"> <i class="fa-brands fa-facebook-f"></i></a>
                            @endif

                            @if ($social_links['Twitter'] != '')
                                <a href="{{ $social_links['Twitter'] }}"> <i class="fa-brands fa-twitter"></i></a>
                            @endif
                            ...
                            @if ($social_links['Linkedin'] != '')
                                <a href="{{ $social_links['Linkedin'] }}"> <i class="fa-brands fa-linkedin"></i></a>
                            @endif


                            @if ($social_links['Youtube'] != '')
                                <a href="{{ $social_links['Youtube'] }}"> <i class="fa-brands fa-youtube"></i></a>
                            @endif
                            @if ($social_links['Pinterest'] != '')
                                <a href="{{ $social_links['Pinterest'] }}"> <i class="fa-brands fa-pinterest"></i></a>
                            @endif
