    ...
    <section id="nextmatchBoard"
        ...
        <div class="container-fluid text-center">
            <div class="row">
                ...
                <div class="personal_details_div col-sm-8 col-md-9 px-5">
                                    ...
                                    <form id="personal_detailsForm" action="{{ route('settings') }}" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 mb-3 text-start">
                                                ...
                                                <div><label for="phone" class="form-label">Mobile No.</label></div>
                                                <div>
                                                <input type="tel" class="form-control"  style="width: 505px" id="phone" name="phone"
                                            ...
                                            <div class="col-sm-6 mb-3 text-end">
                                               <div class="">
                                                <div class="p-5">
                                                    @if (Auth::user()->photo)
                                                    <img src="{{asset('storage/images/user_images/'.Auth::user()->photo)}}" class="border" alt="" height="250px;" width="250px">

                                                    @else
                                                    <img src="{{asset('dist/images/dummy_image.webp')}}" class="border" alt="" height="250px;" width="250px">
                                        ...
                                        <button type="reset"  class="btn btn-secondary my-4">reset</button>
                                    </form>
                                {{-- </div> --}}
                                {{-- <div class="row">
                                    <h2>kdflkkg</h2>
