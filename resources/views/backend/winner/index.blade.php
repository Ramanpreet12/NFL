...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Winner</h2>

    <div class="grid grid-cols-12 gap-6 mt-5 p-5 bg-white">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            {{-- <button class="btn btn-primary shadow-md mr-2">Seasons </button> --}}
            <div class="dropdown">
            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    ...
                    <div class="hidden md:block mx-auto text-slate-500">Season Name</div>
                </div>
            </div>
        </div>
        <!-- BEGIN: Data List -->
