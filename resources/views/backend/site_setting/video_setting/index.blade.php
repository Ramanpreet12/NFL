...
@endif
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <h2 class="text-lg font-medium mr-auto">Video Setting</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <form action="{{route('admin/video/section_heading')}}" method="post">
                @csrf
                    <div id="horizontal-form" class="px-3 flex">
                        @if (!empty($VideoHeading->value))
            ...
            <a class="btn btn-primary shadow-md mr-2" href="{{route('videoSetting.create')}}">Add Video</a>
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="tabulator_videoetting" class="mt-5 table-report table-report--tabulator"></div>
