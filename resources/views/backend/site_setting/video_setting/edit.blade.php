...
@section('subcontent')
    ...
    <div class="grid grid-cols-6 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form action="{{ route('videoSetting.update',$news->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="intro-y box p-5">
                    ...
                    <div class="text-left mt-5">
                        ...
                        <a type="reset" href="{{route('videoSetting.index')}}" class="btn btn-outline-secondary w-24 mr-1">Cancel</a>
                    </div>
                </div>
            </form>
            <!-- END: Form Layout -->
