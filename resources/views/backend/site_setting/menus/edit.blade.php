...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Edit Menu</h2>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="title" type="text" class="form-control" placeholder="title"
                                aria-describedby="input-group-1" name="title" value="{{old('title',$result->title)}}">
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="url" type="text" class="form-control" placeholder="#"
                                aria-describedby="input-group-1" name="url" value="{{old('url',$result->url)}}">
                        </div>
