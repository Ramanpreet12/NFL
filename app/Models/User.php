...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'dob', 'phone_number', 'country_code', 'group' , 'address' , 'city' , 'state' , 'zipcode' , 'country' , 'id_proof_number' , 'id_proof' , 'region_id'
    ];
     ...
     * @var array
     */
    protected $appends = ['photo_path','season'];
